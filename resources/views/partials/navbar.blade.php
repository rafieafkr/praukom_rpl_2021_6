<nav class="flex w-full justify-between bg-white pl-6">
    <div class="py-4">
        <a href="/dashboard" class="font-semibold text-black tracking-widest">SIMAK</a>
    </div>
    <div class="dropdown-end dropdown flex items-center gap-2">
        ...
        <ul tabindex="0"
            ...
            <li
                class="rounded-xl p-1 transition hover:bg-red-500 hover:text-white active:bg-slate-300 active:text-black">
