...
<div class="container px-5 mt-10 bg-white overflow-auto w-full mx-auto">
<div class="bg-white pb-10 w-full">
<!-- Judul Form -->
<div class="w-full text-center mb-10 pt-5">
  <p class="font-extrabold">Form Pengajuan Prakerin</p>
</div>

      <div class=" w-full px-2 grid grid-cols-1 grid-rows-6 md:grid-cols-2 md:grid-rows-3 md:gap-2 font-bold">

        <div class="w-full mb-2">
        <label for="">Siswa</label>
        <input type="text" class="rounded-md shadow-inner w-full border border-gray-400">
        </div>
        <div class="w-full mb-2">
        <label for="">Siswa</label>
        <input type="text" class="rounded-md shadow-inner w-full border border-gray-400">
