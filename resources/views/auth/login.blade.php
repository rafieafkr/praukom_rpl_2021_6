...
<div class="md:flex-warp bg-transparent w-full h-screen m-auto items-center relative">
    <div class="text-center text-6xl m-auto font-thin text-[#ffffff] tracking-widest pt-12 pb-28">S I M A K</div>
    <div class="w-[23em] h-[20em] m-auto items-center">
        <div class="w-[20em] h-[20em] m-auto items-center bg-white rounded-xl">
            <div class="bg-[url('../img/simak.png')] w-[20em] h-[20em] bg-cover m-auto mr-3 items-center"></div>
        </div>
    </div>
...
<div class="md:flex-warp bg-[#404040] w-full h-screen">
    <div class="text-center text-6xl m-auto font-thin text-[#ffffff] tracking-widest pt-12 pb-16">L O G I N</div>
        ...
        <form action="/login" method="POST">
            ...
            <div class="w-full text-center m-auto text-3xl mb-9">
                ...
                <input autofocus type="text" id="email" name="email"
                    class="@error('email') is-invalid @enderror w-3/4 md:w-[20em] h-[2.5em] text-xl text-center bg-[#1F1F1F] border-b-4 border-[#47B5FF]"
            ...
            <div class="w-full text-center m-auto text-3xl mb-32">
                ...
                <input type="password" id="password" name="password"
                    class="w-3/4 md:w-[20em] h-[2.5em] text-xl text-center bg-[#1F1F1F] border-b-4 border-[#47B5FF]"
